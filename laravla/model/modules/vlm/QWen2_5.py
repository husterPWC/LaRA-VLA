...
_ACTION_TOKEN_MAX = 153712 # here only for fast_tokenizer, see laravla/model/modules/vlm/tools/add_qwen_special_tokens/README.md
        ...
        if solutions is not None:
            ...
            for i in range(labels.size(0)):
                ...
                if nonzero_indices.numel() > 0:
                    ...
                    seq[:] = IGNORE_INDEX
                    RuntimeWarning (f"action token are on in yout tokenizer, plz see laravla/model/modules/vlm/tools/add_qwen_special_tokens/README.md.")
