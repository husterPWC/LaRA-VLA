#!/bin/bash
# ============================================================================
# Stage I CoT Training — Server Launch Script
# ============================================================================
# Source this before running, or use directly:
#   bash scripts/run_stage1_server.sh
#
# Prerequisites:
#   1. source scripts/server_env.sh (for EGL if needed, though Stage I doesn't render)
#   2. datasets downloaded to $LARA_REPRO/datasets/
#   3. Checkpoint at $LARA_REPRO/models/LaRA-VLA-libero/
# ============================================================================
...
echo "========================================"
echo "Stage I CoT Training — Server Launch"
echo "========================================"
echo "  LaRA-VLA: $_REPO"
...
echo ""
echo "Done. Check results in $_REPO/results/Stage1_CoT/"
