...
def main():
    ...
    if accelerator.is_main_process:
        ...
        print(f"  Modules: vlm_projector, transition_module, "
              f"current/future/goal_mask_decoder, relation_head")
        print(f"  VLM: frozen (no_grad encode), mask_token_encoder: NOT USED")
    ...
    for step in range(args.max_steps):
        ...
        # P1 forward: transition from VLM only, supervised by all masks
